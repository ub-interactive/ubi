package com.ubi.qdog.controllers.api.web

import com.ubi.qdog.controllers.api.ApiController
...
trait WebApiController extends ApiController {
  ...
  implicit class FileHelper(path: String)
    ...
    def absoluteURL: String = {
      com.ubi.qdog.controllers.routes.ApplicationController.file(path).absoluteURL(environment.mode != Mode.Dev)
    }
  }
