...
//
//import com.stey.api.ApiController
//import com.stey.base.{AuthorizedUserIdentity, SecuredAction, SecuredRequest}
//import com.stey.base.enums.{MobileDevicePlatform, MobileDevicePlatformValue}
//import com.stey.user.models.PermissionModel
...
//  platformC: MobileDevicePlatformValue
//)
//
//object AppMeta {
//  implicit val format: OFormat[AppMeta] = Json.format[AppMeta]
//}
//
//class AppSecuredRequest[A](val appMeta: AppMeta, override val identity: AuthorizedUserIdentity, override val request: Request[A]) extends SecuredRequest[A](identity, request)
//
//trait AppApiController extends ApiController {
//
